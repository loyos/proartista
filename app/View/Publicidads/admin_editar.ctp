...
<div class="edit_imagenes form_item">
	<?php
	echo $this->Form->create('Publicidad', array('type' => 'file','onSubmit' => 'return checkSize();'));
	echo '<table>';
	...
	echo '<table cellspacing="0" cellpadding="10">';
			...
			echo '</td><td>';
			$text = "Agregar foto";
			if (!empty($this->data['Publicidad']['imagen'])){
				echo $this->Html->image('publicidad/'.$this->data['Publicidad']['imagen'], array('width'=>'200px', 'id' => 'upload_imagen'));
		...
		echo '</td></tr><tr><td></td><td>';
			...
			echo "<div class='file_wrap'>";
				echo $text;
				echo $this->Form->file('imagen_publicidad',array(
				'label' => false,
				'id' => 'upload_imagen',
